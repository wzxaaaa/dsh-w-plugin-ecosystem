  ...
  factory: (require) => {
    ...
    var dicts = {
      zh: {
        ...
        assemblyReplaced: "最近一次请求已替换现有 Persona section",
        assemblyInserted: "最近一次请求已追加缺失的 Persona section",
      ...
      en: {
        ...
        assemblyReplaced: "The latest request replaced the existing Persona section",
        assemblyInserted: "The latest request inserted the missing Persona section",
