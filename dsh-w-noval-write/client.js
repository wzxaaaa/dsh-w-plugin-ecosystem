window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function NovelWriterPanel(props) {
      ...
      var tabs = ["project", "characters", "relationships", "world", "plot", "scene", "settings"];
      var content;
      if (tab === "project") {
        ...
        content = React.createElement(CharacterTab, {
          ...
          onDelete: function (id) { updateProject(function (next) { next.characters = next.characters.filter(function (item) { return item.id !== id; }); next.relationships = next.relationships.filter(function (item) { return item.fromId !== id && item.toId !== id; }); if (next.scene.povCharacterId === id) next.scene.povCharacterId = ""; }); setSelectedId(""); },
        });
        ...
        content = React.createElement(RelationshipsTab, {
          ...
          onAdd: function () { updateProject(function (next) { next.relationships.push({
            ...
            dynamic: "", powerBalance: "", publicFace: "", privateTruth: "", sharedSecret: "", tension: "", turningPoints: "", futureDirection: "",
          }); }); },
    ...
    var zh = {
      ...
      saved: "项目设定已保存。", saving: "保存中…", save: "保存", reload: "撤销", unsaved: "有未保存修改", synced: "已与模型上下文同步",
      tab_project: "项目", tab_characters: "角色", tab_relationships: "关系", tab_world: "世界", tab_plot: "情节", tab_scene: "场景", tab_settings: "设置",
    ...
    var en = {
      ...
      saved: "Project canon saved.", saving: "Saving…", save: "Save", reload: "Revert", unsaved: "Unsaved changes", synced: "Synced to model context",
      tab_project: "Project", tab_characters: "Characters", tab_relationships: "Relations", tab_world: "World", tab_plot: "Plot", tab_scene: "Scene", tab_settings: "Settings",
